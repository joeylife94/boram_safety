    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">📊 Excel 일괄 관리</h3>
            <div className="space-y-3">
              <Link
                href="/admin/excel"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium text-gray-900">Excel 업로드</span>
                </div>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              <div className="p-4 bg-orange-50 rounded-lg border border-orange-200">
                <p className="text-sm text-gray-700 mb-2">
                  <span className="font-medium">일괄 업로드로 제품 관리를 빠르게!</span>
                </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">⚙️ 사이트 설정</h3>
            <div className="space-y-3">
              <Link
                href="/admin/settings"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium text-gray-900">사이트 설정</span>
                </div>
                <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <p className="text-sm text-gray-700 mb-2">
                  <span className="font-medium">사이트 기본 정보 관리</span>
                </p>
                <ul className="text-xs text-gray-600 space-y-1">
                  <li>✅ 회사명, 슬로건</li>
                  <li>✅ 연락처, 주소</li>
